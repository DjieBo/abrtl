$(document).ready(function () {
    ...
    listSPK = [];
    let DataSPK = document.querySelectorAll(".SPKVList");
    ...
    let SelcP = document.getElementById("SPKVperiode");
...
function SelectPriodeSPK(value) {
    ...
    ListApp = [];
    let DataApp = document.querySelectorAll(".SPKVApproveList");
    ...
    let SelcRound = document.getElementById("SPKVround");
